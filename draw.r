...
plot(c(1, max(data[,c("Gen_No")]), 1), c(1,max(data[,c("Training", "Test")]), 1), main=paste("Prikaz rezultata za", args[2], sep=" "), xlab="Broj generacije", ylab=paste(args[3], "u %", sep=" "), type="n")
