...
\newpage
\captionof{table}{Uzorci problema Iris}
\begin{center}
...
\begin{table}[H]
\captionof{table}{Rezultati za regresijski GP s jednim stablom}
\begin{center}
\begin{tabular}{| c | c | c |}
\hline
...
\end{table}
\begin{table}[H]
\captionof{table}{Rezultati za regresijski GP s više stabala}
\begin{center}
\begin{tabular}{| c | c | c |}
\hline
Problem & Faktor mutacije & Veličina populacije \\
